...
<body style="background-color: #aa67be;">
    ...
    <div class="text-center" style="color: rgba(17, 29, 44, 0); font-size: 14px; font-weight: bold;">
        <%=message%>
    </div>
                ...
                <div class="thumbnail">
                    ...
                    <form method="post">
                        ...
                        <button type="submit"
                            ...
                            class="btn btn-custom-add">Add to Cart</button>
                        &nbsp;&nbsp;&nbsp;
                        <button type="submit"
                            formaction="./AddToCart?uid=<%=userName%>&pid=<%=product.getProdId()%>&pqty=1"
                            class="btn btn-custom-buy">Buy Now</button>
                        <%
                        } else {
                        %>
                        <button type="submit"
