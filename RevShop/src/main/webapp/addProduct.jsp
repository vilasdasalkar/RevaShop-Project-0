        ...
        <form action="./AddProductServlet" method="post" enctype="multipart/form-data" class="col-md-6 col-md-offset-3"
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input type="number" placeholder="Enter Stock Quantity" name="quantity" class="form-control" id="last_name" min="1" max="10" step="1" required>
                </div>
            </div>
            <div>
                <div class="col-md-12 form-group">
                    <label for="last_name">Product Image</label>
                    <input type="file" placeholder="Select Image" accept=".png, .jpg, .jpeg" name="image" class="form-control" id="last_name" required>
                </div>
            </div>
            <div class="row">
