	...
	public static void main(String[] args) {
		try {
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to RevaShopyy</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with RevaShopyy.<br>"
					...
					+ "<span class='greenText'>RevaShopyy555</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
